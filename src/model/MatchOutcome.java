...
public class MatchOutcome {
    ...
    public final int[] targetBeforeRound;
    public final int[] targetAfterRound;
    public final boolean[] p1StartsRound;
    ...
    public final int[] p1Guesses;
    public final int[] p2Guesses;
